...
NODE_CLASS_MAPPINGS = {
    "AC_MOD加载": AnimateDiffModuleLoader,
    "AC_ADFLora加载": AnimateDiffLoraLoader,
    "AC_图片合并": AnimateDiffCombine,
    "AC_FUN采样器": AnimateDiffSampler,
    "AC_滑块选项": AnimateDiffSlidingWindowOptions,
    "AC_加载视频": LoadVideo,
    "AC_图片信息获取": ImageSizeAndBatchSize,
}
